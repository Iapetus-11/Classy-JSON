...
print()
print('        json average time: {:2.4f} seconds || total time: {}'.format(round(jj_avg, 4), round(jj_total, 10)))
print(' classy-json average time: {:2.4f} seconds || total time: {}'.format(round(cj_avg, 4), round(cj_total, 10)))
